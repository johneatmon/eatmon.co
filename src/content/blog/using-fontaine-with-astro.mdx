...
You want to use `font-display: swap` or `font-display: auto` in your project’s CSS to boost your page loading speed. But when you do, this happens:
...
Mixed with a couple of other font loading strategies — [prefetching font files, subsetting for Latin alphabets, self-hosting your font files, caching your font files](https://leerob.io/blog/fonts) — we can also use `font-display: swap` or `font-display: auto` without having to worry about jarring layout shifts (on non-Webkit browsers).
