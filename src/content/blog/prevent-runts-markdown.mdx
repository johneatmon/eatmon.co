---
title: Remove runts from your Astro Markdown files with ~15 lines of code
...
Have you ever noticed a paragraph of text that ends with a word all by its lonesome on the last line? It looks like this:

<LazyImage
	src="https://imagedelivery.net/le40TwFDWUdIvXckEp8FBw/43061d2a-d60a-43be-929b-7a90eb602000/w=666,h=666,format=webp"
	alt="A visual demonstration of a typographic runt. There is paragraph of lorem ipsum text, and on the last line is the word libero all by itself."
/>
...
Astro makes it super easy to add [remark plugins](https://github.com/remarkjs/remark/blob/main/doc/plugins.md) to your Markdown files. By default, Astro uses a package called `smartypants` to turn straight quotes and apostrophes into curly ones. We can extend this base configuration with our own, custom plugins.
...
_That's it!_ Feel free to tailor the `wordCount` in the `remark-deruntify.mjs` file to your liking -- 4 was a decent starting point for me, personally.

## Working example

<Stackblitz class="not-prose -mx-4 md:-mx-16" projectId="github-xhgus7" file="astro.config.mjs" />
