...
modified: 2022-09-10
image:
  src: "https://cdn.dribbble.com/users/3271731/screenshots/20294159/media/0edb20fd62112ed04e7df948463f0586.png?compress=1&resize=1600x1200&vertical=top"
...
ProSource is an Orland-based technology services provider focused on proving IT solutions to high-complexity industries like healthcare, engineering, finance, and manufacturing. Their mission is to empower teams with thoughtful IT solutions that put people first.
...
Beyond aligning the redesign with the new brand, we wanted to increase user retention, conversion rates, and surface important information.
We looked at our analytics to measure the impact of the redesign, primarily bounce rate and time on page. We also wanted to compare the quantity of conversions before and after the website relaunch.
...
## Anecdotal, qualitative data (“anec-data”)
